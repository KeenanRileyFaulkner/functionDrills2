...
// CODE HERE
const postTaxPrices = prices.map(pretax => (pretax * 1.07).toFixed(2));
...
// CODE HERE
let orderCostAfterTax = orders.map(order => (order.price * (1 + order.tax)).toFixed(2));
console.log(orderCostAfterTax);
